...
import { disableHotel, getDisabledHotels } from '../../../Redux/Actions/actions';
...
function createData(
  ...
  return { Name, Address, Rooms, Owner };
}
...
const headCells: HeadCell[] = [
  { id: 'Name', numeric: false, disablePadding: false, label: 'Name of the Hotel' },
  { id: 'Address', numeric: false, disablePadding: false, label: 'Hotel Address' },
  { id: 'Rooms', numeric: true, disablePadding: false, label: 'No. of Rooms' },
  { id: 'Owner', numeric: false, disablePadding: false, label: 'Owner ID' },
];
