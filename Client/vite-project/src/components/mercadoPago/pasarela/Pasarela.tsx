...
export const Pasarela: React.FC = () => {
    ...
    return (
        <div className='Reservas'>
            ...
            { !MP.Success && (<h2>Cargando configuracion Mercado Pago...</h2>) }
            { !PP.Success && (<h2>Cargando configuracion Paypal ...</h2>) }
                </div>
                <div className='PagosTotal'>
                    ...
                    { PP.Success && ( <div className='Paypal-container'>
                        ...
                        <div className="paypal-powered-by">
                            <span className="paypal-button-text" onClick={handleClick}>Desarrollado por </span>
