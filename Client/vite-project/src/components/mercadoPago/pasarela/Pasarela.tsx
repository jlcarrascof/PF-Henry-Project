...
export const pasarela: React.FC = () => {
    ...
    const handleClick = () => {
        localStorage.removeItem("ReservInfo")
    }
    ...
    return (
        <div className='Reservas'>
                    ...
                    <div className='PasarelaInfo'>
                        ...
                        <div className='InfoPrecio'>
                            <div className='InfoReserva'>
                                <span className='PasarelaDias'>Total days: {Reserva.dias}</span>
                                <span className='PasarelaPrecio'>Price per/day: {Reserva.precio}</span>
                            </div>
            ...
            { !MP.Success && (<h2>Loading Mercado Pago config...</h2>) }
            { !PP.Success && (<h2>Loading PayPal config...</h2>) }
                </div>
                <div className='PagosTotal'>
                    <span className='TotalPagar'>SubTotal: {PagoTotal}</span>
                    { MP.Success && ( <Wallet initialization={{ preferenceId: MP.ID }}/> )}
                    { PP.Success && ( <div className='Paypal-container'>
                        <a className='PaypalButton' href={PP.link} onClick={handleClick}>
                        ...
                        <div className="paypal-powered-by">
                            <span className="paypal-button-text" onClick={handleClick}>Developed by </span>
