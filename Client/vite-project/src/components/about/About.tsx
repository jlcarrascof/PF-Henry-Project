...
const FitnessImage1 =
  'https://c4.wallpaperflare.com/wallpaper/574/214/351/life-resort-hotel-resort-hotel-wallpaper-preview.jpg';
          ...
          {selectedDeveloper === 'AboutUs' && (
            <AnimatedCard>
              <div className={styles.cardContent}>
                <p>
                  Somos un equipo apasionado de entusiastas d comprometidos a proporcionar
