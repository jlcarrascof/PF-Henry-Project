...
const userSchema = new Schema({
  ...
  role: { type: String, enum: ["client", "owner"], default: "client", required: true },
  permissions: { type: String, enum: ["read/write", "create/post/delete"], default: "read/write", required: true },
  profile: {
    firstName: String,
    lastName: String,
    dateOfBirth: Date,
