...
const Pay = new PayPal({
    Auth: {
        ...
        ClientID: 'AZTLK8fSksKKPFNJqEcDNZEM3NjbetYnFIPXMyJoF3U80Utb0RFMy-F1mzzIhYDiJnZpak5jx8itAyX4',
        Token: 'EJZy30aiMWQAY06XCLOfFa7hvRFVfODZMXd8ZkX74RYeSlETe5NNnmzmIbEjks7LGSD8m-mtxqfb0Tg0',
    }
});
...
const PayPalOrder = async (req, rs) => {
    ...
    if (PayData.links) {
        let AproveLink = PayData.links.find((value) => value.rel == 'approve' ? value : undefined);
        rs.json({
            created: true,
...
module.exports = {
    createPreference, Success, PayPalOrder, PayPalCapture
}
